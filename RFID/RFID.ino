...
String accessGranted [2] = {"01476213412", "41297127613"};  //RFID serial numbers to grant access to
int accessGrantedSize = 2;    //The number of serial numbers
String outputMessage ="";   //Final message, this is being sent to the Python script
